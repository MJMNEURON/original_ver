...
objref relay
relay = new SectionList()
for (i = 0; i >= 0; i = i - 1) dend_tc1[i] relay.append()
for (i = 2; i >= 0; i = i - 1) dend_tc2[i] relay.append()
for (i = 12; i >= 0; i = i - 1) dend_tc3[i] relay.append()
for (i = 20; i >= 0; i = i - 1) dend_tc4[i] relay.append()
for (i = 0; i >= 0; i = i - 1) dend_tc5[i] relay.append()
for (i = 30; i >= 0; i = i - 1) dend_tc6[i] relay.append()
for (i = 8; i >= 0; i = i - 1) dend_tc7[i] relay.append()
for (i = 32; i >= 0; i = i - 1) dend_tc8[i] relay.append()
for (i = 46; i >= 0; i = i - 1) dend_tc9[i] relay.append()
for (i = 26; i >= 0; i = i - 1) dend_tc10[i] relay.append()
for (i = 18; i >= 0; i = i - 1) dend_tc11[i] relay.append()
...
proc geometry() { local i, j
    ...
    soma_tc connect dend_tc1[0] (0), 0.5
    soma_tc connect dend_tc2[0] (0), 0.5
    soma_tc connect dend_tc3[0] (0), 0.5
    soma_tc connect dend_tc4[0] (0), 0.5
    soma_tc connect dend_tc5[0] (0), 0.5
    soma_tc connect dend_tc6[0] (0), 0.5
    soma_tc connect dend_tc7[0] (0), 0.5
    soma_tc connect dend_tc8[0] (0), 0.5
    soma_tc connect dend_tc9[0] (0), 0.5
    soma_tc connect dend_tc10[0] (0), 0.5
    soma_tc connect dend_tc11[0] (0), 0.5
        ...
        dend_tc11[i] {
            ...
            for j = 1, fscan() {
                pt3dadd(fscan(),fscan(),fscan(),fscan())
                    ...
                    /* branching topology*/
    for i = 1,0 {
        dend_tc1[fscan()] connect dend_tc1[i] (0), fscan()
    }

    for i = 1,2 {
        dend_tc2[fscan()] connect dend_tc2[i] (0), fscan()
    }

    for i = 1,12 {
        dend_tc3[fscan()] connect dend_tc3[i] (0), fscan()
    }

    for i = 1,20 {
        dend_tc4[fscan()] connect dend_tc4[i] (0), fscan()
    }

    for i = 1,0 {
        dend_tc5[fscan()] connect dend_tc5[i] (0), fscan()
    }

    for i = 1,30 {
        dend_tc6[fscan()] connect dend_tc6[i] (0), fscan()
    }

    for i = 1,8 {
        dend_tc7[fscan()] connect dend_tc7[i] (0), fscan()
    }

    for i = 1,32 {
        dend_tc8[fscan()] connect dend_tc8[i] (0), fscan()
    }

    for i = 1,46 {
        dend_tc9[fscan()] connect dend_tc9[i] (0), fscan()
    }

    for i = 1,26 {
        dend_tc10[fscan()] connect dend_tc10[i] (0), fscan()
    }

    for i = 1,18 {
        dend_tc11[fscan()] connect dend_tc11[i] (0), fscan()
    }
